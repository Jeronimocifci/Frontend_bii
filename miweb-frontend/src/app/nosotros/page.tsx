      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contacto" 
              className="bg-green-700 hover:bg-green-600 transition-colors duration-300 text-white px-8 py-3 rounded-lg text-lg font-semibold inline-block"
            >
              Contáctanos
            </Link>
            <Link 
              href="/productos" 
              className="border-2 border-green-700 hover:bg-green-700 hover:text-white transition-colors duration-300 text-green-700 px-8 py-3 rounded-lg text-lg font-semibold inline-block"
            >
              Ver Productos
            </Link>
          </div>
